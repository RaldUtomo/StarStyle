...
<section class="customers-shell js-customers-shell">
    ...
    <div class="customers-panels">
        <section class="customers-panel is-active" data-customer-panel="customers">
            ...
            <div class="sales-table-card sales-table-card--wide sales-table-card--services customers-table-card">
                <div class="sales-table-scroll sales-table-scroll--services customers-table-scroll">
                    <table class="sales-table sales-table--wide sales-table--services customers-table js-customers-table">
                        <thead>
                        <tr>
                            <th class="sales-table__sticky-left">Nama</th>
                            <th>No. Telpon</th>
                            <th>Email</th>
                            <th>Member ID</th>
                            <th>Loyalty Point</th>
                    ...
                    <tbody>
                        <?php foreach ($customers as $customer): ?>
                            ...
                            <tr>
                                ...
                                <td><?= e($birthdate) ?></td>
                                <td><?= e($tagsText) ?></td>
                                <td class="sales-table__sticky-right"><span class="customers-status-pill"><?= e((string) ($customer['status'] ?? 'Aktif')) ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                ...
                <div class="sales-pagination sales-pagination--services sales-pagination--services-primary sales-pagination--fixed js-customers-pagination">
                    ...
                    <div class="sales-pagination__select-wrap">
                        <button type="button" class="sales-pagination__select js-customers-page-size-toggle" aria-expanded="false">
                            <span class="js-customers-page-size-label">20/page</span><i class="bi bi-chevron-down"></i>
                        </button>
                        <div class="sales-pagination__select-menu js-customers-page-size-menu" hidden>
                            <button type="button" class="sales-pagination__select-option" data-customers-page-size="10">10/page</button>
                            <button type="button" class="sales-pagination__select-option is-active" data-customers-page-size="20">20/page</button>
                            <button type="button" class="sales-pagination__select-option" data-customers-page-size="30">30/page</button>
                            <button type="button" class="sales-pagination__select-option" data-customers-page-size="50">50/page</button>
                        </div>
                    </div>
                    <button type="button" class="sales-pagination__nav js-customers-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                    <div class="sales-pagination__pages js-customers-pages">
                        <span class="sales-pagination__page is-active">1</span>
                    </div>
                    <button type="button" class="sales-pagination__nav js-customers-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                    <div class="sales-pagination__goto">Go to</div>
                    <input class="sales-pagination__input js-customers-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                    <button type="button" class="sales-pagination__top js-customers-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                </div>
            </div>
        </section>
...
<div class="modal fade" id="customerEditModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content customer-modal customer-edit-modal">
                    ...
                    <div class="customer-edit-profile">
                        <div class="customer-edit-profile__summary">
                            ...
                            <div class="customer-edit-profile__shortcuts">
                                <button class="customer-profile-shortcut is-active js-customer-profile-shortcut" type="button" data-customer-profile-target="agenda" data-customer-record-open="1">
                        ...
                        <div class="customer-detail-card js-customer-upcoming-card">
                            ...
                            <div class="customers-table-footer customer-detail-table__footer sales-pagination sales-pagination--services sales-pagination--services-primary">
                                <div class="sales-pagination__meta"><span class="js-customer-upcoming-total">Total 0</span></div>
                                <div class="sales-pagination__select-wrap">
                                    <button type="button" class="sales-pagination__select js-customer-page-size-toggle" data-customer-page-scope="upcoming" aria-expanded="false">
                                        <span class="js-customer-page-size-label" data-customer-page-scope="upcoming">20/page</span><i class="bi bi-chevron-down"></i>
                                    </button>
                                    <div class="sales-pagination__select-menu js-customer-page-size-menu" data-customer-page-scope="upcoming" hidden>
                                        <button type="button" class="sales-pagination__select-option" data-customer-page-size="10" data-customer-page-scope="upcoming">10/page</button>
                                        <button type="button" class="sales-pagination__select-option is-active" data-customer-page-size="20" data-customer-page-scope="upcoming">20/page</button>
                                        <button type="button" class="sales-pagination__select-option" data-customer-page-size="50" data-customer-page-scope="upcoming">50/page</button>
                                    </div>
                                </div>
                                <button class="sales-pagination__nav js-customer-page-prev" type="button" data-customer-page-scope="upcoming"><i class="bi bi-chevron-left"></i></button>
                                <span class="sales-pagination__page js-customer-page-current" data-customer-page-scope="upcoming">1</span>
                                <button class="sales-pagination__nav js-customer-page-next" type="button" data-customer-page-scope="upcoming"><i class="bi bi-chevron-right"></i></button>
                                <div class="sales-pagination__goto">Go to</div>
                                <input class="sales-pagination__input js-customer-page-input" type="text" value="1" inputmode="numeric" pattern="[0-9]*" data-customer-page-scope="upcoming" aria-label="Go to customer upcoming page">
                                <button type="button" class="sales-pagination__top js-customer-table-top" data-customer-page-scope="upcoming" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="customer-detail-card js-customer-past-card">
                            ...
                            <div class="customers-table-footer customer-detail-table__footer sales-pagination sales-pagination--services sales-pagination--services-primary">
                                <div class="sales-pagination__meta"><span class="js-customer-past-total">Total 0</span></div>
                                <div class="sales-pagination__select-wrap">
                                    <button type="button" class="sales-pagination__select js-customer-page-size-toggle" data-customer-page-scope="past" aria-expanded="false">
                                        <span class="js-customer-page-size-label" data-customer-page-scope="past">20/page</span><i class="bi bi-chevron-down"></i>
                                    </button>
                                    <div class="sales-pagination__select-menu js-customer-page-size-menu" data-customer-page-scope="past" hidden>
                                        <button type="button" class="sales-pagination__select-option" data-customer-page-size="10" data-customer-page-scope="past">10/page</button>
                                        <button type="button" class="sales-pagination__select-option is-active" data-customer-page-size="20" data-customer-page-scope="past">20/page</button>
                                        <button type="button" class="sales-pagination__select-option" data-customer-page-size="50" data-customer-page-scope="past">50/page</button>
                                    </div>
                                </div>
                                <button class="sales-pagination__nav js-customer-page-prev" type="button" data-customer-page-scope="past"><i class="bi bi-chevron-left"></i></button>
                                <span class="sales-pagination__page js-customer-page-current" data-customer-page-scope="past">1</span>
                                <button class="sales-pagination__nav js-customer-page-next" type="button" data-customer-page-scope="past"><i class="bi bi-chevron-right"></i></button>
                                <div class="sales-pagination__goto">Go to</div>
                                <input class="sales-pagination__input js-customer-page-input" type="text" value="1" inputmode="numeric" pattern="[0-9]*" data-customer-page-scope="past" aria-label="Go to customer past page">
                                <button type="button" class="sales-pagination__top js-customer-table-top" data-customer-page-scope="past" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="customer-record-layer js-customer-record-layer" hidden>
                <div class="customer-record-layer__header">
                    <div></div>
                    <h2>Catatan Pelanggan</h2>
                    <button type="button" class="customer-record-layer__close js-customer-record-close" aria-label="Tutup catatan pelanggan">
                        <i class="bi bi-x-lg"></i>
                    </button>
                </div>

                <div class="customer-record-layer__tabs" role="tablist" aria-label="Tab catatan pelanggan">
                    <button class="customer-record-layer__tab is-active js-customer-record-tab" type="button" data-customer-record-tab="notes">Catatan</button>
                    <button class="customer-record-layer__tab js-customer-record-tab" type="button" data-customer-record-tab="tags">Record Tag</button>
                </div>

                <div class="customer-record-layer__body">
                    <div class="customer-record-toolbar">
                        <div class="customer-record-date-wrap">
                            <button type="button" class="customer-record-date js-customer-record-date-toggle" aria-expanded="false">
                                <i class="bi bi-calendar3"></i>
                                <span class="js-customer-record-week-label">Pilih pekan</span>
                            </button>
                            <div class="customer-record-calendar js-customer-record-calendar" hidden>
                                <div class="customer-record-calendar__head">
                                    <button type="button" class="js-customer-record-prev-month" aria-label="Bulan sebelumnya"><i class="bi bi-chevron-double-left"></i></button>
                                    <strong class="js-customer-record-calendar-title">2026 July</strong>
                                    <button type="button" class="js-customer-record-next-month" aria-label="Bulan berikutnya"><i class="bi bi-chevron-double-right"></i></button>
                                </div>
                                <div class="customer-record-calendar__weekdays">
                                    <span>Sun</span><span>Mon</span><span>Tue</span><span>Wed</span><span>Thu</span><span>Fri</span><span>Sat</span>
                                </div>
                                <div class="customer-record-calendar__grid js-customer-record-calendar-grid"></div>
                            </div>
                        </div>

                        <div class="customer-record-export-wrap">
                            <button type="button" class="customer-record-export js-customer-record-export-toggle" aria-expanded="false">
                                <span>Export</span><i class="bi bi-caret-down-fill"></i>
                            </button>
                            <div class="customer-record-export-menu js-customer-record-export-menu" hidden>
                                <button type="button" data-customer-record-export="csv">CSV</button>
                                <button type="button" data-customer-record-export="pdf">PDF</button>
                            </div>
                        </div>

                        <label class="customer-record-search">
                            <input class="js-customer-record-search" type="search" placeholder="Cari...">
                            <i class="bi bi-search"></i>
                        </label>
                    </div>

                    <div class="customer-record-filter-row">
                        <button type="button" class="customer-record-filter js-customer-record-filter" aria-label="Filter catatan">
                            <i class="bi bi-caret-down-fill"></i>
                        </button>
                    </div>

                    <div class="customer-record-list js-customer-record-list"></div>
                    <div class="customer-record-empty js-customer-record-empty" hidden>Tidak ada catatan.</div>
                </div>

                <button type="button" class="customer-record-fab js-customer-record-add" aria-label="Tambah catatan">
                    <i class="bi bi-plus-lg"></i>
                </button>
            </div>
