...
usort($voucherRows, static function (array $left, array $right): int {
    $leftExpiry = strtotime((string) ($left['expired_at'] ?? $left['expiry_value'] ?? $left['expiry_label'] ?? '')) ?: 0;
    $rightExpiry = strtotime((string) ($right['expired_at'] ?? $right['expiry_value'] ?? $right['expiry_label'] ?? '')) ?: 0;
    $expiryCompare = $rightExpiry <=> $leftExpiry;
    if ($expiryCompare !== 0) {
...
usort($discountRows, static function (array $left, array $right): int {
    return (int) ($right['id'] ?? 0) <=> (int) ($left['id'] ?? 0);
});
    ...
    <div class="vouchers-panels">
        <section class="vouchers-panel is-active js-vouchers-panel" data-vouchers-panel="voucher">
            ...
            <div class="inventory-table-card vouchers-table-card">
                <div class="inventory-table-wrap vouchers-table-scroll">
                ...
                <div class="sales-pagination sales-pagination--services sales-pagination--services-primary sales-pagination--fixed vouchers-pagination js-voucher-pagination">
                    <div class="sales-pagination__meta">Total <span class="js-voucher-total"><?= e((string) count($voucherRows)) ?></span></div>
                    <div class="sales-pagination__select-wrap">
                        <button type="button" class="sales-pagination__select js-voucher-page-size-toggle" aria-expanded="false">
                            <span class="js-voucher-page-size-label">20/page</span><i class="bi bi-chevron-down"></i>
                        </button>
                        <div class="sales-pagination__select-menu js-voucher-page-size-menu" hidden>
                            <button type="button" class="sales-pagination__select-option" data-voucher-page-size="10">10/page</button>
                            <button type="button" class="sales-pagination__select-option is-active" data-voucher-page-size="20">20/page</button>
                            <button type="button" class="sales-pagination__select-option" data-voucher-page-size="30">30/page</button>
                            <button type="button" class="sales-pagination__select-option" data-voucher-page-size="50">50/page</button>
                        </div>
                    </div>
                    <button type="button" class="sales-pagination__nav js-voucher-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                    <div class="sales-pagination__pages js-voucher-pages"><span class="sales-pagination__page is-active">1</span></div>
                    <button type="button" class="sales-pagination__nav js-voucher-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                    <div class="sales-pagination__goto">Go to</div>
                    <input class="sales-pagination__input js-voucher-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                    <button type="button" class="sales-pagination__top js-voucher-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                </div>
            </div>
        </section>
