                ...
                <div class="services-toolbar__group">
                    <div class="services-menu-wrap services-toolbar__shop-menu">
                        ...
                        <div class="services-dropdown services-dropdown--toolbar" data-services-menu>
                            <button class="is-active" type="button" data-services-shop-option="groups" data-shop-name="Star Salon">Star Salon</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="services-toolbar">
                <div class="services-toolbar__group">
                    <div class="services-menu-wrap services-toolbar__shop-menu">
                        ...
                        <div class="services-dropdown services-dropdown--toolbar" data-services-menu>
                            <button class="is-active" type="button" data-services-shop-option="services" data-shop-name="Star Salon">Star Salon</button>
                        </div>
                    </div>
            ...
            <div class="services-toolbar">
                <div class="services-toolbar__group">
                    <div class="services-menu-wrap services-toolbar__shop-menu">
                        ...
                        <div class="services-dropdown services-dropdown--toolbar" data-services-menu>
                            <button class="is-active" type="button" data-services-shop-option="packages" data-shop-name="Star Salon">Star Salon</button>
                        </div>
                    </div>
                    <div class="services-menu-wrap services-toolbar-dropdown">
                        <button class="dashboard-filter services-toolbar-dropdown__toggle" type="button" data-services-menu-toggle>
