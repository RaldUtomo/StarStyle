...
$inventoryRowTimestamp = static function (array $row, string $key): int {
...
usort($purchaseRows, static function (array $left, array $right) use ($inventoryRowTimestamp): int {
    $dateCompare = $inventoryRowTimestamp($right, 'created_at') <=> $inventoryRowTimestamp($left, 'created_at');
    if ($dateCompare !== 0) {
        return $dateCompare;
    }

    return strnatcasecmp((string) ($right['document'] ?? ''), (string) ($left['document'] ?? ''));
});
...
usort($opnameRows, static function (array $left, array $right) use ($inventoryRowTimestamp): int {
    $dateCompare = $inventoryRowTimestamp($right, 'started_at') <=> $inventoryRowTimestamp($left, 'started_at');
    if ($dateCompare !== 0) {
        return $dateCompare;
    }
...
<section class="inventory-shell js-inventory-shell">
    ...
    <div class="inventory-panel is-active" data-inventory-panel="products">
        ...
        <div class="inventory-table-card">
            ...
            <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="products">
                <div class="inventory-pagination__meta">Total <span class="js-inventory-total"><?= e((string) count($productRows)) ?></span></div>
                <div class="inventory-pagination__select-wrap">
                    <button type="button" class="inventory-pagination__select js-inventory-page-size-toggle" aria-expanded="false">
                        <span class="js-inventory-page-size-label">20/page</span><i class="bi bi-chevron-down"></i>
                    </button>
                    <div class="inventory-pagination__select-menu js-inventory-page-size-menu" hidden>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-page-size="10">10/page</button>
                        <button type="button" class="inventory-pagination__select-option is-active" data-inventory-page-size="20">20/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-page-size="30">30/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-page-size="50">50/page</button>
                    </div>
                </div>
                <button type="button" class="inventory-pagination__nav js-inventory-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                <div class="inventory-pagination__pages js-inventory-pages"><span class="inventory-pagination__page is-active">1</span></div>
                <button type="button" class="inventory-pagination__nav js-inventory-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                <div class="inventory-pagination__goto">Go to</div>
                <input class="inventory-pagination__input js-inventory-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                <button type="button" class="inventory-pagination__top js-inventory-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="inventory-panel" data-inventory-panel="purchases" hidden>
        ...
        <div class="inventory-table-card">
            ...
            <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="purchases">
                <div class="inventory-pagination__meta">Total <span class="js-inventory-purchase-total"><?= e((string) count($purchaseRows)) ?></span></div>
                <div class="inventory-pagination__select-wrap">
                    <button type="button" class="inventory-pagination__select js-inventory-purchase-page-size-toggle" aria-expanded="false">
                        <span class="js-inventory-purchase-page-size-label">20/page</span><i class="bi bi-chevron-down"></i>
                    </button>
                    <div class="inventory-pagination__select-menu js-inventory-purchase-page-size-menu" hidden>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-purchase-page-size="10">10/page</button>
                        <button type="button" class="inventory-pagination__select-option is-active" data-inventory-purchase-page-size="20">20/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-purchase-page-size="30">30/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-purchase-page-size="50">50/page</button>
                    </div>
                </div>
                <button type="button" class="inventory-pagination__nav js-inventory-purchase-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                <div class="inventory-pagination__pages js-inventory-purchase-pages"><span class="inventory-pagination__page is-active">1</span></div>
                <button type="button" class="inventory-pagination__nav js-inventory-purchase-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                <div class="inventory-pagination__goto">Go to</div>
                <input class="inventory-pagination__input js-inventory-purchase-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                <button type="button" class="inventory-pagination__top js-inventory-purchase-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="inventory-panel" data-inventory-panel="opname" hidden>
        ...
        <div class="inventory-table-card">
            ...
            <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="opname">
                <div class="inventory-pagination__meta">Total <span class="js-inventory-opname-total"><?= e((string) count($opnameRows)) ?></span></div>
                <div class="inventory-pagination__select-wrap">
                    <button type="button" class="inventory-pagination__select js-inventory-opname-page-size-toggle" aria-expanded="false">
                        <span class="js-inventory-opname-page-size-label">20/page</span><i class="bi bi-chevron-down"></i>
                    </button>
                    <div class="inventory-pagination__select-menu js-inventory-opname-page-size-menu" hidden>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-opname-page-size="10">10/page</button>
                        <button type="button" class="inventory-pagination__select-option is-active" data-inventory-opname-page-size="20">20/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-opname-page-size="30">30/page</button>
                        <button type="button" class="inventory-pagination__select-option" data-inventory-opname-page-size="50">50/page</button>
                    </div>
                </div>
                <button type="button" class="inventory-pagination__nav js-inventory-opname-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                <div class="inventory-pagination__pages js-inventory-opname-pages"><span class="inventory-pagination__page is-active">1</span></div>
                <button type="button" class="inventory-pagination__nav js-inventory-opname-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                <div class="inventory-pagination__goto">Go to</div>
                <input class="inventory-pagination__input js-inventory-opname-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                <button type="button" class="inventory-pagination__top js-inventory-opname-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="inventory-panel" data-inventory-panel="master" hidden>
        ...
        <div class="inventory-master-panel is-active" data-inventory-master-panel="brands">
            ...
            <div class="inventory-table-card">
                ...
                <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="brands">
                    <div class="inventory-pagination__meta">Total <span class="js-inventory-brand-total"><?= e((string) count($brandRows)) ?></span></div>
                    <div class="inventory-pagination__select-wrap">
                        <button type="button" class="inventory-pagination__select js-inventory-brand-page-size-toggle" aria-expanded="false"><span class="js-inventory-brand-page-size-label">20/page</span><i class="bi bi-chevron-down"></i></button>
                        <div class="inventory-pagination__select-menu js-inventory-brand-page-size-menu" hidden>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-brand-page-size="10">10/page</button>
                            <button type="button" class="inventory-pagination__select-option is-active" data-inventory-brand-page-size="20">20/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-brand-page-size="30">30/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-brand-page-size="50">50/page</button>
                        </div>
                    </div>
                    <button type="button" class="inventory-pagination__nav js-inventory-brand-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                    <div class="inventory-pagination__pages js-inventory-brand-pages"><span class="inventory-pagination__page is-active">1</span></div>
                    <button type="button" class="inventory-pagination__nav js-inventory-brand-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                    <div class="inventory-pagination__goto">Go to</div>
                    <input class="inventory-pagination__input js-inventory-brand-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                    <button type="button" class="inventory-pagination__top js-inventory-brand-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="inventory-master-panel" data-inventory-master-panel="categories" hidden>
            ...
            <div class="inventory-table-card">
                ...
                <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="categories">
                    <div class="inventory-pagination__meta">Total <span class="js-inventory-category-total"><?= e((string) count($categoryRows)) ?></span></div>
                    <div class="inventory-pagination__select-wrap">
                        <button type="button" class="inventory-pagination__select js-inventory-category-page-size-toggle" aria-expanded="false"><span class="js-inventory-category-page-size-label">20/page</span><i class="bi bi-chevron-down"></i></button>
                        <div class="inventory-pagination__select-menu js-inventory-category-page-size-menu" hidden>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-category-page-size="10">10/page</button>
                            <button type="button" class="inventory-pagination__select-option is-active" data-inventory-category-page-size="20">20/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-category-page-size="30">30/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-category-page-size="50">50/page</button>
                        </div>
                    </div>
                    <button type="button" class="inventory-pagination__nav js-inventory-category-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                    <div class="inventory-pagination__pages js-inventory-category-pages"><span class="inventory-pagination__page is-active">1</span></div>
                    <button type="button" class="inventory-pagination__nav js-inventory-category-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                    <div class="inventory-pagination__goto">Go to</div>
                    <input class="inventory-pagination__input js-inventory-category-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                    <button type="button" class="inventory-pagination__top js-inventory-category-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="inventory-master-panel" data-inventory-master-panel="suppliers" hidden>
            ...
            <div class="inventory-table-card">
                ...
                <div class="inventory-pagination inventory-pagination--primary js-inventory-pagination" data-inventory-pagination-scope="suppliers">
                    <div class="inventory-pagination__meta">Total <span class="js-inventory-supplier-total"><?= e((string) count($supplierRows)) ?></span></div>
                    <div class="inventory-pagination__select-wrap">
                        <button type="button" class="inventory-pagination__select js-inventory-supplier-page-size-toggle" aria-expanded="false"><span class="js-inventory-supplier-page-size-label">20/page</span><i class="bi bi-chevron-down"></i></button>
                        <div class="inventory-pagination__select-menu js-inventory-supplier-page-size-menu" hidden>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-supplier-page-size="10">10/page</button>
                            <button type="button" class="inventory-pagination__select-option is-active" data-inventory-supplier-page-size="20">20/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-supplier-page-size="30">30/page</button>
                            <button type="button" class="inventory-pagination__select-option" data-inventory-supplier-page-size="50">50/page</button>
                        </div>
                    </div>
                    <button type="button" class="inventory-pagination__nav js-inventory-supplier-prev" aria-label="Halaman sebelumnya"><i class="bi bi-chevron-left"></i></button>
                    <div class="inventory-pagination__pages js-inventory-supplier-pages"><span class="inventory-pagination__page is-active">1</span></div>
                    <button type="button" class="inventory-pagination__nav js-inventory-supplier-next" aria-label="Halaman berikutnya"><i class="bi bi-chevron-right"></i></button>
                    <div class="inventory-pagination__goto">Go to</div>
                    <input class="inventory-pagination__input js-inventory-supplier-page-current" type="text" value="1" inputmode="numeric" pattern="[0-9]*" aria-label="Go to page">
                    <button type="button" class="inventory-pagination__top js-inventory-supplier-top" aria-label="Scroll ke atas"><i class="bi bi-chevron-up"></i></button>
                </div>
            </div>
        </div>
    </div>
