...
final class DemoData
{
    public static function make(array $config): array
    {
        ...
        return [
            ...
            'reviews' => [
                ['customer' => 'Citra Aulia', 'email' => 'customer@starstyle.test', 'rating' => 5, 'feedback' => 'Coloring rapi, staff komunikatif, hasilnya mewah sekali.', 'date' => $date(0, '18:00:00'), 'agenda' => 'Review Booking #1001'],
                ['customer' => 'Alif Rahman', 'email' => 'alif@starstyle.test', 'rating' => 4, 'feedback' => 'Haircut presisi dan cepat, waiting time singkat.', 'date' => $date(0, '13:00:00'), 'agenda' => 'Review Booking #1002'],
                ['customer' => 'Naura Sofia', 'email' => 'naura@starstyle.test', 'rating' => 5, 'feedback' => 'Creambath nyaman, ruangan bersih, hasil blow dry tahan lama.', 'date' => $date(-1, '16:45:00'), 'agenda' => 'Review Booking #1003'],
                ['customer' => 'Dimas Pratama', 'email' => 'dimas@starstyle.test', 'rating' => 4, 'feedback' => 'Stylist memberi saran model rambut yang cocok dan pengerjaannya rapi.', 'date' => $date(-1, '11:18:00'), 'agenda' => 'Review Booking #1004'],
                ['customer' => 'Maya Lestari', 'email' => 'maya.lestari@starstyle.test', 'rating' => 5, 'feedback' => 'Nail art detail, warna sesuai request, pelayanan sangat ramah.', 'date' => $date(-2, '19:05:00'), 'agenda' => 'Review Booking #1005'],
                ['customer' => 'Raka Wijaya', 'email' => 'raka@starstyle.test', 'rating' => 3, 'feedback' => 'Hasil haircut bagus, hanya saja jadwal mundur sedikit dari booking.', 'date' => $date(-3, '14:22:00'), 'agenda' => 'Review Booking #1006'],
                ['customer' => 'Salsa Nabila', 'email' => 'salsa@starstyle.test', 'rating' => 5, 'feedback' => 'Balayage natural dan konsultasinya detail sebelum mulai treatment.', 'date' => $date(-3, '17:30:00'), 'agenda' => 'Review Booking #1007'],
                ['customer' => 'Fajar Nugroho', 'email' => 'fajar@starstyle.test', 'rating' => 4, 'feedback' => 'Head spa relaks, therapist profesional, area treatment sangat nyaman.', 'date' => $date(-4, '12:10:00'), 'agenda' => 'Review Booking #1008'],
                ['customer' => 'Laras Kirana', 'email' => 'laras@starstyle.test', 'rating' => 5, 'feedback' => 'Keratin repair bikin rambut lebih halus dan mudah diatur.', 'date' => $date(-5, '15:40:00'), 'agenda' => 'Review Booking #1009'],
                ['customer' => 'Bima Arya', 'email' => 'bima@starstyle.test', 'rating' => 4, 'feedback' => 'Booking mudah, staff ramah, checkout cepat dan jelas.', 'date' => $date(-6, '10:25:00'), 'agenda' => 'Review Booking #1010'],
            ],
            'activity_logs' => [
            ...
            'notifications' => [
                ['customer' => 'Citra Aulia', 'email' => 'customer@starstyle.test', 'title' => 'Reminder booking Signature Haircut terkirim', 'type' => 'info', 'type_label' => 'Info', 'agenda' => 'Booking #1001', 'created_at' => $date(0, '18:10:00')],
                ['customer' => 'Alif Rahman', 'email' => 'alif@starstyle.test', 'title' => 'Konfirmasi jadwal Haircut berhasil dikirim', 'type' => 'success', 'type_label' => 'Success', 'agenda' => 'Booking #1002', 'created_at' => $date(0, '13:15:00')],
                ['customer' => 'Naura Sofia', 'email' => 'naura@starstyle.test', 'title' => 'Ucapan terima kasih setelah Creambath dikirim', 'type' => 'info', 'type_label' => 'Info', 'agenda' => 'Booking #1003', 'created_at' => $date(-1, '17:00:00')],
                ['customer' => 'Dimas Pratama', 'email' => 'dimas@starstyle.test', 'title' => 'Link review layanan dikirim ke pelanggan', 'type' => 'review', 'type_label' => 'Review', 'agenda' => 'Booking #1004', 'created_at' => $date(-1, '11:40:00')],
                ['customer' => 'Maya Lestari', 'email' => 'maya.lestari@starstyle.test', 'title' => 'Voucher follow-up nail art berhasil dikirim', 'type' => 'promo', 'type_label' => 'Promo', 'agenda' => 'Booking #1005', 'created_at' => $date(-2, '19:20:00')],
                ['customer' => 'Raka Wijaya', 'email' => 'raka@starstyle.test', 'title' => 'Notifikasi perubahan jadwal dikirim', 'type' => 'warning', 'type_label' => 'Warning', 'agenda' => 'Booking #1006', 'created_at' => $date(-3, '14:35:00')],
                ['customer' => 'Salsa Nabila', 'email' => 'salsa@starstyle.test', 'title' => 'Reminder treatment Balayage H-1 terkirim', 'type' => 'info', 'type_label' => 'Info', 'agenda' => 'Booking #1007', 'created_at' => $date(-3, '17:45:00')],
                ['customer' => 'Fajar Nugroho', 'email' => 'fajar@starstyle.test', 'title' => 'Pesan aftercare Head Spa dikirim', 'type' => 'aftercare', 'type_label' => 'Aftercare', 'agenda' => 'Booking #1008', 'created_at' => $date(-4, '12:30:00')],
                ['customer' => 'Laras Kirana', 'email' => 'laras@starstyle.test', 'title' => 'Panduan aftercare Keratin Repair terkirim', 'type' => 'aftercare', 'type_label' => 'Aftercare', 'agenda' => 'Booking #1009', 'created_at' => $date(-5, '16:00:00')],
                ['customer' => 'Bima Arya', 'email' => 'bima@starstyle.test', 'title' => 'Invoice dan ringkasan booking dikirim', 'type' => 'billing', 'type_label' => 'Billing', 'agenda' => 'Booking #1010', 'created_at' => $date(-6, '10:40:00')],
            ],
            'settings' => [
