...
$router->get('/booking/payment/success', [PublicController::class, 'bookingPaymentSuccess']);
...
$router->get('/customer/google', [PublicController::class, 'customerGoogleRedirect']);
$router->get('/customer/google/callback', [PublicController::class, 'customerGoogleCallback']);
...
$router->get('/analytics/export', [AdminController::class, 'analyticsExport']);
...
$router->post('/api/sales/invoice/status', [ApiController::class, 'salesInvoiceStatus']);
$router->post('/api/sales/invoice/payment-detail', [ApiController::class, 'salesInvoicePaymentDetail']);
$router->get('/api/account/state', [ApiController::class, 'accountState']);
$router->post('/api/account/profile', [ApiController::class, 'accountProfileSave']);
$router->post('/api/account/password', [ApiController::class, 'accountPasswordSave']);
$router->post('/api/account/security', [ApiController::class, 'accountSecuritySave']);
$router->post('/api/account/verify', [ApiController::class, 'accountVerify']);
